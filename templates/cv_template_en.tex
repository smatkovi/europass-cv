\documentclass[helvetica,english,logo,notitle,totpages,utf8]{europass-cv}
\usepackage{graphicx}
...
\ecvsection{Projects}
\ecvproject{Year/duration}{Title of project}{Byline/place}{More details \par More details}
