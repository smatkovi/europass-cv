\documentclass[helvetica,english,logo,notitle,totpages,utf8]{europass-cv-compact}
\usepackage{graphicx}
...
pdftitle={Prasad Tengse CV},
pdfsubject={Resume},
pdfkeywords={prasad-cv;prasad resume;tengse;resume;tengse cv},
pdfproducer={Latex with hyperref TeXstudio/Travis},
pdfcreator={pdflatex},
bookmarks=false,
colorlinks=true,
...
\ecvposition{Job/Position/Studies applied for}{Replace with job applied for / position / preferred job / studies applied for (delete non relevant headings in left column)}
...
\ecvsection{Projects}
\ecvproject{Year/duration}{Title of project}{Byline/place}{More details}{}
